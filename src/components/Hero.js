...
const Hero = () => {
  return (
    <div className="w-full max-h-full bg-zinc-200 flex flex-col py-9 justify-between  ">
      <div className="grid max-w-[1240px] m-auto gap-5 md:grid-cols-2 ">
      <div>
          <img src={bgimg} alt="/" className="w-full rounded-full px-4" />
        </div>
        <div className="flex flex-col justify-center md:items-start w-full px-4 py-8">
          ...
          <button className="py-3 px-6 sm:w-[60%] my-1">Get Started</button>
        </div>
